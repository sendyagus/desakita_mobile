...
class BookingReportPdfService {
  Future<void> printReport({
    ...
    await Printing.layoutPdf(
      ...
      name:
          'laporan-booking-${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
          ...
          pw.Header(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text(
                  'Periode: ${BookingAnalyticsHelper.periodLabel(period)}',
                ),
              ...
              data: List.generate(bookings.length, (i) {
                ...
                return [
                  ...
                  user['full_name'] as String? ??
                      ...
                      '-',
                  BookingAnalyticsHelper.statusLabel(
                    b['status'] as String? ?? '',
                  ),
